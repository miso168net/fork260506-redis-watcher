...
| 項目 | 內容 |
|---|---|
| 此 repo | `miso168net/fork260506-redis-watcher` |
| 原始專案(推測) | `casbin/redis-watcher`(可能透過 `go-admin-team/redis-watcher` 中轉) |
| Fork 用途 | 個人學習與實驗用 fork |
| Fork 建立日 | 2026-05-06 |
| `main` 來源分支 | `master` |
| 建立時的來源 HEAD | `bfe327c` — feat✨: upgrade to 1.20 and related dependencies(2023-11-02) |
